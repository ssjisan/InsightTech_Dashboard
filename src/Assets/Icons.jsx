...
export const ProjectRequest = () => {
    ...
    return (
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.3335 1.83331V4.58331" stroke={pathname === "/project_request" ? "#00AE60" : "#B0AEC3"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M14.6665 1.83331V4.58331" stroke={pathname === "/project_request" ? "#00AE60" : "#B0AEC3"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M6.4165 11.9167H13.7498" stroke={pathname === "/project_request" ? "#00AE60" : "#B0AEC3"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M6.4165 15.5833H10.9998" stroke={pathname === "/project_request" ? "#00AE60" : "#B0AEC3"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M14.6667 3.20831C17.7192 3.37331 19.25 4.53748 19.25 8.84581V14.5108C19.25 18.2875 18.3333 20.1758 13.75 20.1758H8.25C3.66667 20.1758 2.75 18.2875 2.75 14.5108V8.84581C2.75 4.53748 4.28083 3.38248 7.33333 3.20831H14.6667Z" stroke={pathname === "/project_request" ? "#00AE60" : "#B0AEC3"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
export const Remove = () => {
